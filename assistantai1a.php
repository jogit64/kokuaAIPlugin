...
class Assistant1a_Widget extends WP_Widget
{
    ...
    {
        // Vérifier si le shortcode [assistant1a] est présent dans le contenu de la page
        if (is_singular() && has_shortcode(get_post_field('post_content', get_the_ID()), 'assistant1a')) {
...
function assistant1a_enqueue_styles_and_scripts()
{
    // Vérifier si le shortcode [assistant1a] est présent dans le contenu de la page
    global $post;
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'assistant1a')) {
        // Le shortcode est présent, charger le CSS et le script JavaScript
...
add_action('wp_enqueue_scripts', 'assistant1a_enqueue_styles_and_scripts');
                        ...
                        <div id="cost-estimate-container">
                            <div class="details-container">
                                ...
                                <div class="quality-details">
                                    ...
                                    <div id="token-progress-bar" style="width: 100%; background-color: #ddd; height: 24px; margin-top: 5px;">
                                        <div id="token-progress" style="height: 100%; width: 0%; background-color: #4CAF50;"></div>
                                    </div>
